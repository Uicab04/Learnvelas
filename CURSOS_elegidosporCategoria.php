...
// Verificar si se ha enviado el parámetro "parent"
...
if(isset($_GET['id'])){
    ...
    echo "El valor de 'parent' es: " . $parent;
} else {
                ...
                <div style="border: 2px solid #ccc; border-radius: 8px; overflow: hidden;">
                  ...
                  <div class="cc_course-card-footer" style="border-top: 1px solid #ccc; padding: 20px;">
                    ...
                    <div class="cc_course-card-footer-item arrow u-bgc-2">
                      <div class="icon-1-25 w-embed"><svg width="100%" height="100%" viewBox="0 0 14 12" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M8.25 0.5L7.46 1.22L11.35 5.5H0.75V6.5H11.35L7.46 10.78L7.97 11.5L13.25 6L8.25 0.5Z" fill="currentColor"></path></svg></div>
                    </div>
                  </div>
                </div>
              </a>
