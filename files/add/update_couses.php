...
// Verifica si se ha enviado el ID del video
if(isset($_GET['id'])) {
    $idVideo = $_GET['id'];
    // Haz lo que necesites hacer con el ID del video
    // echo "ID del video: " . $idVideo;
} else {
    echo "No se ha proporcionado el ID del video";
}

$db = new Conexion();
$sql = "SELECT * FROM course_links WHERE id = $idVideo";
$resultado2 = $db->query($sql);

// Verifica si se encontraron resultados
if ($resultado2 !== false && $resultado2->rowCount() > 0) {
    // Recorrer los resultados
    while ($fila = $resultado2->fetch(PDO::FETCH_ASSOC)) {
        // Llenar los campos del formulario
        $titulo = $fila['title'];
        $shortDesc = $fila['short_description'];
        $desc = $fila['description'];
        $reqs = $fila['requirements'];
        $keywords = $fila['meta_keywords'];
        $thumb = $fila['thumbnail'];
        $video = $fila['video_url'];
        $iDSubCategoria = $fila['category_id'];

        // $descripcion = $fila['descripcion'];
        // $url = $fila['url'];
    }
} else {
    echo "No se encontraron resultados para el ID de video proporcionado.";
}
// echo $iDSubCategoria;
                                        ...
                                        <form class="required-form" id="form1"
                                                ...
                                                <div id="basicwizard">
                                                    ...
                                                    <ul class="nav nav-pills nav-justified form-wizard-header mb-3">
                                                        <!-- <li class="nav-item">
                                                            <a href="#Subtemas" data-toggle="tab"
                                                                class="nav-link rounded-0 pt-2 pb-2">
                                                                <i class="mdi mdi-currency-cny mr-1"></i>
                                                                <span class="d-none d-sm-inline">
                                                                    <font style="vertical-align: inherit;">
                                                                        <font style="vertical-align: inherit;">Subtemas
                                                                        </font>
                                                                    </font>
                                                                </span>
                                                            </a>
                                                            ...
                                                            <div class="row justify-content-center">
                                                                <div class="col-xl-8">
                                                                    <div class="form-group row mb-3">
                                                                        ...
                                                                        <div class="col-sm-6 mb-3 mb-sm-0">
                                                                            <input type="text"
                                                                                ...
                                                                                placeholder="nombre" value="<?php echo $titulo; ?>">
                                                                        </div>
                                                                    ...
                                                                    <div class="form-group row mb-3">
                                                                        ...
                                                                        <div class="col-md-10">
                                                                            <textarea name="short_description"
                                                                                ...
                                                                                class="form-control"><?php echo $shortDesc; ?></textarea>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    if ($menu->rowCount() > 0) {
                                                                        ...
                                                                        echo '<label class="col-md-2 col-form-label" for="sub_category_id">';
                                                                        echo '<font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Categoría </font></font>';
                                                                        echo '<span class="required"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">*</font></font></span>';
                                                                        echo '</label>';
                                                                        ...
                                                                        echo '<font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Seleccione una categoría</font></font>';
                                                                        echo '</option>';
                                                                        ...
                                                                        while ($row = $menu->fetch(PDO::FETCH_ASSOC)) {
                                                                            if ($row["parent"] == 0) {
                                                                                ...
                                                                                if (isset($iDSubCategoria) && $iDSubCategoria == $row["id"]) {
                                                                                    echo ' selected';
                                                                                }
                                                                                echo ' disabled>' . $row["name"] . '</option>';
                                                                                ...
                                                                                while ($sub_row = $subcategories->fetch(PDO::FETCH_ASSOC)) {
                                                                                    echo '<option value="' . $sub_row["id"] . '" data-parent="' . $sub_row["parent"] . '"';
                                                                                    if (isset($iDSubCategoria) && $iDSubCategoria == $sub_row["id"]) {
                                                                                        echo ' selected';
                                                                                    }
                                                                                    echo '>' . $sub_row["name"] . '</option>';
                                                                                }
                                                                            }
                                                                        }
...
<!-- 
 ...
 -->
                                                                                    ...
                                                                                    <div class="flex-grow-1 px-3">
                                                                                        <div class="form-group">
                                                                                            <input type="text"
                                                                                                ...
                                                                                                name="requirements[]"
                                                                                                id="requirements"
                                                                                                placeholder="Proporcionar requisitos" value="<?php echo $reqs; ?>">
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="">
                                                                                        <button type="button"
                                                        ...
                                                        z-index: -1;
                                                        left: 80px; /* Ajustar la posición del círculo */
                                                        }
                                                        ...
                                                        background-color: #4CAF50;
                                                        top: 50%;
                                                        left: 90px; /* Mover al principio */
                                                        z-index: -2;
                                                        }

                                                        </style>

<div class="tab-pane" id="Subtemas">
                                                        <div class="row justify-content-center">
                                                            <div class="col-lg-10 col-md-12">
                                                            <div class="lessons">
                                                                
                                                                <?php
                                                                // Ejemplo de temario dividido por temas
                                                                $temario = array(
                                                                "Tema 1" => array(
                                                                    "Marketing digital y tradicional en la empresa",
                                                                    "Conoce al cliente"
                                                                ),
                                                                "Tema 2" => array(
                                                                    "Tema 2 - Sección 1",
                                                                ...
                                                                // Iterar sobre el temario para mostrar cada lección por tema
                                                                foreach ($temario as $tema => $secciones) {
                                                                ?>
                                                                <h3><?php echo $tema; ?></h3>
                                                                <?php foreach ($secciones as $index => $leccion) { ?>
                                                                    ...
                                                                    <div class="lesson-box">
                                                                        ...
                                                                        <div class="lesson-content"><?php echo $leccion; ?></div>
                                                                        </div>
                                                                    </div>
                                                                    </div>
                                                                <?php } ?>
                                                                <?php } ?>
                                                                <div id="ver-mas">
                                                                <button onclick="mostrarTodo()">Ver más</button>
                                                                </div>
                                                            </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        function mostrarTodo() {
                                                            document.querySelectorAll('.lesson-container').forEach(function(container) {
                                                                    ...
                                                                    <div class="form-group row mb-3">
                                                                        ...
                                                                        <div class="col-md-10">
                                                                            <input type="text"
                                                                                ...
                                                                                data-role="tagsinput"
                                                                                style="width: 100%; display: none;" value="<?php echo $keywords; ?>">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-12">
                                                                    <div class="text-center">
                                                                        ...
                                                                        <h3 class="mt-0">Sube un video !</h3>

                                                                        <p class="w-75 mb-2 mx-auto">Estas a un click de subir un video</p>
...
<!-- Contenido previo del formulario --> <style>
                                        ...
                                        <div id="form2-container">
                                            <form id="form2" action="uploadUpdate.php" method="post" enctype="multipart/form-data">
                                                <!-- Contenido del formulario 2 -->
                                                <p>VIDEO ACTUAL: <?php echo $video; ?></p>
                                                <input type="file" class="form-control-file" id="videoS" name="videoS" accept="video/*">
                                                <input type="submit" value="Upload Video" name="uploadButton" style="display: none;"> <!-- Ocultar el botón de envío -->
                                            </form>
                                        </div>

                                            <input type="button" value="Submit" onclick="submitForm2()" class="btn btn-primary btn-user btn-block" style="display: none;">
                                            <hr>


                                            <form id="form3" action="update_imagenesCursos.php" method="post" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group" id="thumbnail-picker-area">
                                                    ...
                                                    <div class="input-group">
                                                        <div class="custom-file">
                                                            ...
                                                            <label class="custom-file-label" for="category_thumbnail"><?php echo $thumb; ?></label>
                                                        </div>
                                                    </div>
                                                </div>
...
<script>
    ...
    function submitForm3() {
        ...
        fetch('update_imagenesCursos.php', {
            method: 'POST',
            body: formData3
        })
        .then(response => {
        ...
        .then(data => {
            ...
            camposActualizarCursos(nombreVideo, nombreImagen, <?php echo $idVideo; ?>);
